...
namespace Modeling1
{
    ...
    {
        //Находит оптимальную перестановку для двух деталей
        public static int[,] GetBestPermutation(int[,] matrix)
        {
            /*Метод перебирает все возможные перестановки строк матрицы и для каждой перестановки 
            вычисляет общее время простоев и сохраняет перестановку с минимальным временем простоев*/
        ...
        //Метод вычисляет общее время простоев для 2 деталей
        ...
        //Метод вычисляет общее время простоев для 3 деталей
        ...
        //Генерирует следующую перестановку, если она последняя в порядке то возвращает false
        ...
        ////Находит оптимальную перестановку для трех деталей
