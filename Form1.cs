...
namespace Modeling1
{
    public partial class Form1 : System.Windows.Forms.Form
    {
        ...
        //Метод для отображения информации о соответствии номера детали и цвета на графике
        ...
        private void buttonTask1_Click(object sender, EventArgs e) 
        {
            ...
            task1 = new int[5, 2];
            string filePath = "C:\\Users\\chand\\МОИ ПАПКИ\\УЧЕБА\\7 семестр\\Моделирование\\Laba_1\\task1.txt";
        ...
        private void buttonTask2_Click(object sender, EventArgs e)
        {
            ...
            task2 = new int[5, 3];
            string filePath = "C:\\Users\\chand\\МОИ ПАПКИ\\УЧЕБА\\7 семестр\\Моделирование\\Laba_1\\task2.txt";
        ...
        //Метод для проверки условия, возможно ли преобразование матрицы от вида Nx3 к виду Nx2
        ...
        //Метод сводит задачу с тремя станками к задаче с двуммя станками
